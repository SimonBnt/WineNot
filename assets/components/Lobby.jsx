                ...
                <>
                    {showBackShop || backShopQuickAcessIsClicked ? (
                        ...
                        <>
                            ...
                            <LobbyModal modalIsOpenHandleClick={modalIsOpenHandleClick} />

                            {/* SLIDERS MODAL CONTAINER */}

                            <div id="sliderModalContainer">
                                {showSlider && <Slider country={selectedCountry} closeSliderHandleClick={closeSliderHandleClick} />}
                            </div>

                            {/* SLIDERS OPENERS */}

                            <div
                                className="slidersOpeners"
                                id="lobbySliderOpener1"
                                title="Ouvre le catalogue des vins Français"
                                onClick={() => showSliderHandleClick("France")}
                            ></div>
                            <div
                                className="slidersOpeners"
                                id="lobbySliderOpener2"
                                title="Ouvre le catalogue des vins Italiens"
                                onClick={() => showSliderHandleClick("Italie")}
                            ></div>
                            <div
                                className="slidersOpeners"
                                id="lobbySliderOpener3"
                                title="Ouvre le catalogue des vins du Portugal & Espagne"
                                onClick={() => showSliderHandleClick("Portugal & Espagne")}
                            ></div>
