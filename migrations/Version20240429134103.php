 ...
 */
final class Version20240429134103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wine (id INT AUTO_INCREMENT NOT NULL, region_id INT DEFAULT NULL, title1 VARCHAR(255) NOT NULL, price NUMERIC(10, 2) NOT NULL, date INT NOT NULL, title2 VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_560C646898260155 (region_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
